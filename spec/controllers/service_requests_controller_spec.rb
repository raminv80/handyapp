...
describe ServiceRequestsController do
  ...
  let(:valid_attributes) { { "geolat" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved service_request as @service_request" do
        ...
        post :create, {:service_request => { "geolat" => "invalid value" }}, valid_session
        expect(assigns(:service_request)).to be_a_new(ServiceRequest)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested service_request" do
        ...
        expect_any_instance_of(ServiceRequest).to receive(:update).with({ "geolat" => "MyString" })
        put :update, {:id => service_request.to_param, :service_request => { "geolat" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the service_request as @service_request" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ServiceRequest.any_instance.stub(:save).and_return(false)
        put :update, {:id => service_request.to_param, :service_request => { "geolat" => "invalid value" }}, valid_session
        expect(assigns(:service_request)).to eq(service_request)
      end
